...
export const blogs = [
  {
    title: 'Türkiye’de en ucuz emek, entelektüel emek!',
    date: 'Aralık 2024',
    link: '/path-to-blog-12',
    image: '../assets/images/blog/blog5.jpg',
    description: 'Cengiz Kahraman; fotoğraf editörü, araştırmacısı ve koleksiyoneri. Kariyeri de bu sıralamayla ilerlemiş. Üniversiteden mezun olduktan sonra tesadüfler sonucunda İstanbul Ansiklopedisi’nde yardımcı fotoğraf editörü olarak işe başlamış. Meslek hayatının geri kalanını belirleyen bu karar, kişisel ilgisinin yönünü de büyük ölçüde tayin etmiş diyebiliriz. O vakte kadar fotoğraf çekmekten zevk alan bir gençken zamanla başkalarının çektiği fotoğrafların hikayelerini kovalar olmuş. Eski İstanbul fotoğrafları, o fotoğrafların anlattığı hikayeler, vizörün ardındaki isimler… Cengiz Bey, eski İstanbul fotoğrafları ve erken dönem foto muhabirleri denilince akla gelen ilk isimlerden biri. Kendisini bulmuşken fotoğraf koleksiyonculuğunun incelikleri, zorlukları ve dijital teknolojinin fotoğraf koleksiyonculuğuna etkilerini de içeren keyifli bir sohbet gerçekleştirdik.'
  },
  {
  ...
  {
    title: '"Biz Çalıkuşu Nesliyiz!"',
    date: 'Ekim 2024',
    link: '/path-to-blog-10',
