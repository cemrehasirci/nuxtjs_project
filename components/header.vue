<template>
  ...
  <header class="header">
    <a href="#">
      Aradığınız Kitabın Adresi 📚 İndirimler ve Kampanyalar 👍 18 Yıldır Güvenle
    </a>
  </header>
  ...
  <div class="top-bar">
    ...
    <div class="links">
      ...
      <a href="#" style="color: #981515;" >Yardım</a>
  ...
  <div class="red-bar">
      ...
      <router-link to="/dergi">Dergiler</router-link>
      <span class="separator"></span>
